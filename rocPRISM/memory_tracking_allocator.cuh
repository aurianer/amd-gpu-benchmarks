...
// Simple portable memory tracking resource for Thrust algorithms
...
public:
    ...
    {
        // Use thrust::device_malloc which works with both CUDA and HIP
    ...
    virtual void do_deallocate(void* ptr, std::size_t bytes, std::size_t) override
    {
        ...
        // Use thrust::device_free which works with both CUDA and HIP
